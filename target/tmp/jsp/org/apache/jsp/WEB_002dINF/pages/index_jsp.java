...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            } else {\r\n");
      out.write("                var html = '<table class=\"table table-bordered urlHistory\"><thead><tr><td>Оригинальная ссылка</td><td>Короткая ссылка</td><td>Дата добавления</td><td>Оставшийся срок</td><td>Клики</td><td>Действия</td></tr></thead><tbody>';\r\n");
      out.write("                urls.forEach(function (url) {\r\n");
      out.write("                    html += '<tr>' +\r\n");
      out.write("                            '<td style=\"width: 50%\"><div class=\"origUrl\"><a href=\"' + url.originalLink + '\" target=\"_blank\">' + url.originalLink + '</a><div></td>' +\r\n");
      out.write("                            '<td><input style=\"cursor: pointer\" type=\"text\" class=\"form-control\" readonly onclick=\"this.select();\" value=\"localhost:8080/' + url.shortCode + '\"/></td>' +\r\n");
      out.write("                            '<td>';\r\n");
      out.write("                    var date = new Date(url.createdAt);\r\n");
      out.write("                    html += date.getDate() + '.' + (date.getMonth() + 1) + '.' + date.getFullYear();\r\n");
      out.write("                    html += '</td>' +\r\n");
      out.write("                            '<td>' + (Math.ceil((url.deletedAt - new Date()) / (1000 * 60 * 60 * 24))) + ' дней</td>' +\r\n");
      out.write("                            '<td>'+url.clicks+'</td>' +\r\n");
      out.write("                            '<td><i class=\"glyphicon glyphicon-plus\" style=\"cursor: pointer\" onclick=\"extendUrl('+url.id+');\"></i><i class=\"glyphicon glyphicon-trash\"style=\"cursor: pointer\" onclick=\"deleteUrl('+url.id+');\"></i></td>' +\r\n");
      out.write("                            '</tr>';\r\n");
      out.write("                });\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function deleteUrl(id){\r\n");
      out.write("        var url='url/'+id+'/delete';\r\n");
      out.write("        $.post(url, function () {\r\n");
      out.write("            loadUrls();\r\n");
      out.write("        })\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function extendUrl(id){\r\n");
      out.write("        var url='url/'+id+'/extend';\r\n");
      out.write("        $.post(url, function () {\r\n");
      out.write("            loadUrls();\r\n");
      out.write("        })\r\n");
      out.write("    }\r\n");
